...
HEADERS = ["Equip. ID", "Category", "Tool Type / Model", "Supplier", "Region", "Ccy",
           ...
           "Throughput (u/hr)", "Op Hrs/Yr", "Annual Energy Cost (USD)", "Engineering Notes"]
...
def build(wb, named):
    ...
    row = title_block(ws, 1, "S02", "CapEx Equipment Portfolio Dataset — Advanced Manufacturing Program",
                       "Program: Greenfield Expansion Phase II | Fiscal Year: 2025 | Program Manager: Sourabh Tarodekar | Status: Active | "
                       "Blue = Hardcoded Input · Black = Formula · Green = Cross-sheet Link", n_cols=18)
    ...
    # Totals row
    ws.cell(row=r, column=1, value="TOTAL / PORTFOLIO").font = BOLD
    ...
    row = section_header(ws, r, 1, "PORTFOLIO SUMMARY STATISTICS", 2, 1)
    stats = [
    ...
    autosize(ws, {1: 10, 2: 20, 3: 34, 4: 24, 5: 8, 6: 6, 7: 12, 8: 6, 9: 14, 10: 14,
                  11: 13, 12: 8, 13: 13, 14: 12, 15: 12, 16: 10, 17: 14, 18: 46})
